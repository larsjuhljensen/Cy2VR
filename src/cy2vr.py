...
def write_html(prefix, network, ar, dark, nodesize, radius):
	...
	try:
		...
		f.write('    <script src="aframe-extras.min.js"></script>\n')
		...
		f.write('      <a-entity id="rig" movement-controls="speed: 0.05"  position="0.0 0.0 0.0">\n')
		f.write('        <a-entity id="camera" camera look-controls="pointerLockEnabled: true" position="0.0 1.6 0.0"></a-entity>\n')
		f.write('      </a-entity>\n')
